...
public class Cammera : MonoBehaviour
{
    ...
    private void CameraPositionStart()
    {
        ...
        transform.DOMoveZ(transform.position.z + Speed*Time.deltaTime, 0.1f); //mueve la camara
    }
    ...
    {
        if (Input.GetKeyDown(KeyCode.A))                                              //si se pulsa la flecha izquierda
        {
        ...
        if (Input.GetKeyDown(KeyCode.D))                                             //si se pulsa la flecha derecha
        {
